...
- [[roivant]] — Roivant Sciences (NASDAQ: ROIV), NYC biopharma that builds a family of nimble drug-dev subsidiaries ("Vants"; 9 FDA approvals). Cole's live target = its **Rotational Analyst Program** (2yr, four 6-month rotations, ~$100k, NYC relocation). The **science + capital + operator** two-lens fit (Neuro/pre-med × [[jhtv]] × [[uship]]). Outreach contact: [[Sophie Katz]] (LinkedIn DM, Sept 2026). ⚠️ Confirm current-cycle grad window fits May 2027.

### VC / investor applications — Cole (VC stretch lane, see [[Job Search]])
...
- [[reaction-order-kinetics]] — zero-order vs first-order; why alcohol clears at a flat ~1 drink/hr and can't be rushed.
