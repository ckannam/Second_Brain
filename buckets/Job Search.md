...
- **Role:** **startup operator** (primary — most feasible) *or* **VC** (stretch, worth a parallel attempt).
  ...
  - **VC applications hub:** [[vc-investor-applications]] — every other student-VC app in one place. **Applied: DRF, Contrary, ShangBay, Bessemer (full-time analyst, 2026-09-20).** In process: Tactile. Pipeline: KP Fellows, 8VC, Vertex/5AM (health), [[catalio-capital]] (warm), Z Fellows, Neo, GC Venture Fellows (~Mar 2027). Final answer texts stored for reuse.
  - **Interview prep:** [[vc-interview-prep]] — Bessemer's "How to prepare" framework (know the firm · stay informed on tech · practice asking questions · get excited about a category) as Cole's study plan. Category locked = **techbio / AI drug discovery**.
...
- NeuroTech Consulting (science→GTM), Duke research labs, 3.91 GPA, **$380K+** raised (Shave & Buzz).

## 🗂️ Networking engine  (built 2026-07-27)
The **[[outreach-pipeline|Outreach Pipeline]]** is the board Cole works every week; the
**[[outreach-kit|Outreach Kit]]** is the reusable positioning fuel. **Trigger is manual:** each
...
## Market intel — job-search services
- [[relentless]] (joinrelentless.com) — a **done-for-you executive job-search service**: resume/
  positioning, direct recruiter/hiring-manager outreach, interview prep, and calendar management, so you
  "wake up to a calendar full of interviews." It's the **paid, full-service mirror of Cole's own
  [[outreach-pipeline]] + [[outreach-kit]]** — a useful reference for what to systematize. Built for
  senior/exec searches with a comp-increase ROI story, so **not a fit for a 2027 new-grad search**; the
  value is knowing how it works. *(Cole flagged it for Q&A — ingested 2026-08-18.)*
...
## Action items (personal — lives here, not on the vault board)
- [ ] **Weekly (Mon AM):** work the [[outreach-pipeline]] batch — review the Gmail drafts the engine staged, send, update statuses. (added 2026-07-27)
- [ ] **Approve the first outreach batch** — the engine can draft the warm JHTV contacts + Brad Lightcap now; give the go. (added 2026-07-27)
- [ ] **Reconnect with [[Arielle (Forus Health)|Arielle]] near graduation (~Feb–Mar 2027)** about joining the Forus Health team — *as agreed on the 7/14 call*. (added 2026-07-27)
