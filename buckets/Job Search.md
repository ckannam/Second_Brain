...
- **Role:** **startup operator** (primary — most feasible) *or* **VC** (stretch, worth a parallel attempt).
  ...
  - **VC applications hub:** [[vc-investor-applications]] — every other student-VC app in one place. **Applied: DRF, Contrary, ShangBay.** In process: Bessemer. Pipeline: KP Fellows, 8VC, Vertex/5AM (health), [[catalio-capital]] (warm), Z Fellows, Neo, GC Venture Fellows (~Mar 2027). Final answer texts stored for reuse.
