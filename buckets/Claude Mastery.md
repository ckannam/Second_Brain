...
- Skills & agents: [[claude-code-skills]], [[claude-code-skill-creation-playbook]] (end-to-end build + trigger-tune + evals guide), [[master-claude-code-skills-28min]], [[master-claude-code-36min-beginner]], [[claude-code-subagents]], [[claude-code-agent-teams]], [[skills-vs-subagents]], [[parallel-agents]].
