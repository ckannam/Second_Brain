...
Models referenced (a **point-in-time snapshot** — model names age fast, so treat the older ones
as historical): the Opus line runs [[opus-4-5]] → [[opus-4-6]] (benchmarked vs GPT 5.4 in
[[codex-plugin-for-claude-code]]) → [[opus-4-7]], all seen across the July 2026 **Code with Claude**
talks and now **superseded by [[opus-4-8]]** as the current flagship; plus the [[mythos]] →
[[fable-5|Fable]] line.
...
[[claude-managed-agents]] (production agent platform), [[claude-cowork]] (delegated
async work), [[claude-science]] and industry [[the-briefing-financial-services|briefings]],
and internal-practice talks ([[how-we-claude-code]], [[running-ai-native-engineering-org]],
