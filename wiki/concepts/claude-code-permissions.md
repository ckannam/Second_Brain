...
Pair Auto Mode with deny-rules (e.g. block destructive `rm`) so unattended runs ([[claude-code-scheduled-tasks]]) can't go off the rails. Related: [[claude-code-hooks]].
