...
tags:
  - "WebClip"
---
[![ECC - the agent harness operating system](https://github.com/affaan-m/ECC/raw/main/assets/hero.png)](https://github.com/affaan-m/ECC/blob/main/assets/hero.png)[![GitHub Trending Repository of the Day](https://camo.githubusercontent.com/77eabde1160297b928231b6d4f1a52e498f1b8f692d844582833bd7f5953e01e/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f62616467653f7265706f3d61666661616e2d6d2f45434326747970653d7472656e64696e67)](https://www.star-history.com/affaan-m/ecc)[

![Star History Global Rank](https://camo.githubusercontent.com/3136630c523b4020a57af66c24d84bf23a8a011acbdf3a879359c7e622f14785/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f62616467653f7265706f3d61666661616e2d6d2f45434326747970653d72616e6b)

](https://www.star-history.com/affaan-m/ecc)

**Language:** [English](https://github.com/affaan-m/ECC/blob/main/README.md) | [Português (Brasil)](https://github.com/affaan-m/ECC/blob/main/docs/pt-BR/README.md) | [简体中文](https://github.com/affaan-m/ECC/blob/main/README.zh-CN.md) | [繁體中文](https://github.com/affaan-m/ECC/blob/main/docs/zh-TW/README.md) | [日本語](https://github.com/affaan-m/ECC/blob/main/docs/ja-JP/README.md) | [한국어](https://github.com/affaan-m/ECC/blob/main/docs/ko-KR/README.md) | [Türkçe](https://github.com/affaan-m/ECC/blob/main/docs/tr/README.md) | [Русский](https://github.com/affaan-m/ECC/blob/main/docs/ru/README.md) | [Tiếng Việt](https://github.com/affaan-m/ECC/blob/main/docs/vi-VN/README.md) | [ไทย](https://github.com/affaan-m/ECC/blob/main/docs/th/README.md) | [Deutsch](https://github.com/affaan-m/ECC/blob/main/docs/de-DE/README.md) | [Español](https://github.com/affaan-m/ECC/blob/main/docs/es/README.md) | [Українська](https://github.com/affaan-m/ECC/blob/main/docs/uk-UA/README.md)
...
| [![ECC Tools](https://github.com/affaan-m/ECC/raw/main/assets/images/community/ecc-tools-mark.svg)   **ECC Pro + GitHub App**](https://ecc.tools/pricing)   <sub><a href="https://github.com/apps/ecc-tools">Install free</a> · <a href="https://ecc.tools/pricing">Private repos from $19/seat/mo</a></sub> | [![](https://github.com/affaan-m/ECC/raw/main/assets/images/community/heart.svg)   **Sponsor ECC**](https://github.com/sponsors/affaan-m)   <sub>Fund the open-source project</sub> | [![Discord](https://github.com/affaan-m/ECC/raw/main/assets/images/community/discord.svg)   **Community**](https://discord.gg/36yGMHGFbR)   <sub>Discord · Q&amp;A · Show and Tell</sub> |
| --- | --- | --- |

<sub><strong>OSS stays free.</strong> This repo is MIT-licensed forever. ECC Pro is the hosted GitHub App for private repos. <a href="https://github.com/sponsors/affaan-m">Sponsors</a> and <a href="https://ecc.tools/pricing">Pro subscribers</a> fund the work. That's why a single maintainer ships weekly across 7 harnesses.</sub>

<sub><strong>Partners &amp; sponsors</strong></sub>

[![CodeRabbit](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/coderabbit.png)](https://www.coderabbit.ai/ "CodeRabbit") [![Greptile](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/greptile.png)](https://www.greptile.com/go/ecc "Greptile")[![](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/atlascloud-dark.svg)](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=ECC "Atlas Cloud")

[

![Moonshot AI - Kimi](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/moonshot-dark.png)

](https://platform.kimi.ai/?aff=ecc "Moonshot AI - Kimi")[

![Itô Markets](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/ito-transparent-light.png)

](https://compute.itomarkets.com/ "Itô Markets")
...
<sub><a href="https://github.com/sponsors/affaan-m"><strong>Become a Sponsor</strong></a> · <a href="https://github.com/affaan-m/ECC/blob/main/SPONSORS.md">Sponsor Tiers</a> · <a href="https://github.com/affaan-m/ECC/blob/main/SPONSORING.md">Sponsorship Program</a></sub>
...
| AgentShield | Included | Scanning for prompts, hooks, MCP config, permissions, secrets, and agent files |[![ECC star history: first 40,000 stars, January 18 to February 7, 2026](https://github.com/affaan-m/ECC/raw/main/assets/star-history-light.svg)](https://www.star-history.com/affaan-m/ecc)## Install ECC

> [!important] Important
> ECC 2.2 includes guided package setup for Claude Code, Codex, and Kimi Code. The universal package requires Node.js 18 or newer. Claude plugin setup also requires Git and Claude Code 2.1 or newer on `PATH`.
...
For repo navigation, surface ownership, and PR diff packet guidance, read the [Codex ECC Navigation Map](https://github.com/affaan-m/ECC/blob/main/docs/CODEX-NAVIGATION-GUIDE.md). See the [.codex plugin notes](https://github.com/affaan-m/ECC/blob/main/.codex-plugin/README.md) for native lifecycle details.
...
| Antigravity | `./install.sh --profile minimal --target antigravity` | See the [Antigravity guide](https://github.com/affaan-m/ECC/blob/main/docs/ANTIGRAVITY-GUIDE.md) |
| Qwen CLI | `./install.sh --profile minimal --target qwen` | See the [Qwen guide](https://github.com/affaan-m/ECC/blob/main/docs/QWEN-GUIDE.md) |
| Hermes | `./install.sh --profile minimal --target hermes` | See the [Hermes setup guide](https://github.com/affaan-m/ECC/blob/main/docs/HERMES-SETUP.md) |
...
For a harness without a native ECC target, use the [manual adaptation guide](https://github.com/affaan-m/ECC/blob/main/docs/MANUAL-ADAPTATION-GUIDE.md). It explains how to carry a small set of ECC skills and workflow instructions into chat-style tools without pretending hooks or native skill discovery are available.
...
Any install whose profile or modules would materialize the hook runtime requires an explicit decision. Without `--enable-hooks` or `--no-hooks`, the installer prints what the hooks can do and stops before writing anything. The guided installer (`ecc install --guided`) asks for this choice interactively.
...
That installs the hook scripts under `~/.claude/` and registers the resolved hook entries in `~/.claude/settings.json`. Existing user settings and hooks are preserved; ECC-owned entries are tracked by stable ID for idempotent updates and safe uninstall.
...
| [  ![Itô Markets](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/ito-transparent-light.png)     **1\. Get GPU capacity**](https://compute.itomarkets.com/)   <sub>Use Itô or any GPU provider.</sub> | [  ![Moonshot AI - Kimi](https://github.com/affaan-m/ECC/raw/main/assets/images/sponsors/moonshot-dark.png)     **2\. Serve Kimi**](https://www.moonshot.ai/)   <sub>Expose the chosen checkpoint through a compatible endpoint.</sub> | [![ECC Tools](https://github.com/affaan-m/ECC/raw/main/assets/images/community/ecc-tools-mark.svg)   **3\. Run Kimi Code with ECC**](https://github.com/affaan-m/ECC/blob/main/.kimi/README.md)   <sub>Install project instructions and skills, then start Kimi Code.</sub> |
| --- | --- | --- |

Configure the endpoint with Kimi Code's [official provider guide](https://moonshotai.github.io/kimi-cli/en/configuration/providers.html), then install ECC:
...
Full history: [CHANGELOG.md](https://github.com/affaan-m/ECC/blob/main/CHANGELOG.md). Per-release notes and evidence live under [docs/releases/](https://github.com/affaan-m/ECC/blob/main/docs/releases).

### v2.0.0: The Agent Harness Operating System (Jun 2026)

Stable graduation of the 2.0 line: control-pane substrate, worktree lifecycle service, the `orch-*` orchestrator family, and the Discord community. Notes: [docs/releases/2.0.0/release-notes.md](https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/release-notes.md).
...
See [`rules/README.md`](https://github.com/affaan-m/ECC/blob/main/rules/README.md) for installation and structure details.

## Guides

This repo is the raw code. The guides explain everything.

| [![The Shorthand Guide to ECC](https://github.com/affaan-m/ECC/raw/main/assets/images/guides/shorthand-guide.png)   **The Shorthand Guide**](https://github.com/affaan-m/ECC/blob/main/the-shortform-guide.md)   <sub>Setup, foundations, and day-one use. <b>Read this first.</b> (<a href="https://x.com/affaan/status/2012378465664745795">thread</a>)</sub> | [![The Longform Guide to ECC](https://github.com/affaan-m/ECC/raw/main/assets/images/guides/longform-guide.png)   **The Longform Guide**](https://github.com/affaan-m/ECC/blob/main/the-longform-guide.md)   <sub>Context economics, memory, evals, and parallel agents. (<a href="https://x.com/affaan/status/2014040193557471352">thread</a>)</sub> | [![The Security Guide to ECC](https://github.com/affaan-m/ECC/raw/main/assets/images/guides/security-guide.png)   **The Security Guide**](https://github.com/affaan-m/ECC/blob/main/the-security-guide.md)   <sub>Prompt injection, hooks, MCP, and AgentShield. (<a href="https://x.com/affaan/status/2033263813387223421">thread</a>)</sub> |
| --- | --- | --- |
...
[Commands Quick Reference](https://github.com/affaan-m/ECC/blob/main/COMMANDS-QUICK-REF.md) | [Manual Adaptation Guide](https://github.com/affaan-m/ECC/blob/main/docs/MANUAL-ADAPTATION-GUIDE.md) | [Troubleshooting FAQ](https://github.com/affaan-m/ECC/blob/main/TROUBLESHOOTING.md) | [Roadmap](https://github.com/affaan-m/ECC/blob/main/docs/ROADMAP.md)
...
[Open the Unified Memory workflow →](https://github.com/affaan-m/ECC/blob/main/skills/unified-memory/SKILL.md)
...
For opt-in MCP access, add the `ecc-memory-vault` entry from [`mcp-configs/mcp-servers.json`](https://github.com/affaan-m/ECC/blob/main/mcp-configs/mcp-servers.json) to each harness that needs it, then run `ecc-memory-mcp`. The server exposes only `memory_save`, `memory_search`, `memory_read`, and `memory_doctor`. Each server must launch with a lowercase `ECC_MEMORY_HARNESS` identity; the identity is server-bound and cannot be supplied by a tool caller. User scope additionally requires the operator-controlled `ECC_MEMORY_ALLOW_USER_SCOPE=1` opt-in. See [`skills/unified-memory/SKILL.md`](https://github.com/affaan-m/ECC/blob/main/skills/unified-memory/SKILL.md) for the workflow and trust boundaries, and [`docs/design/ecc-memory-vault.md`](https://github.com/affaan-m/ECC/blob/main/docs/design/ecc-memory-vault.md) for the capability contract.
...
- [Hermes setup guide](https://github.com/affaan-m/ECC/blob/main/docs/HERMES-SETUP.md)
- [Migration guide from 1.x](https://github.com/affaan-m/ECC/blob/main/docs/MIGRATION-1X-TO-2.0.md)

## Token Optimization

Agent usage can be expensive if you don't manage token consumption. These settings significantly reduce costs without sacrificing quality. Full guide: [docs/token-optimization.md](https://github.com/affaan-m/ECC/blob/main/docs/token-optimization.md).
...
- GitHub repository: [https://github.com/affaan-m/ECC](https://github.com/affaan-m/ECC)
...
- GitHub App: [https://github.com/apps/ecc-tools](https://github.com/apps/ecc-tools)
...
```
- **Report a vulnerability.** Use the private process in [SECURITY.md](https://github.com/affaan-m/ECC/blob/main/SECURITY.md) (GitHub private vulnerability reporting). Please do not open public issues for security reports.
...
If context is getting heavy, run `/context-budget`, remove rules you do not need, and disable unused MCP servers. See the [token optimization guide](https://github.com/affaan-m/ECC/blob/main/docs/token-optimization.md).
...
- [MCP connector policy](https://github.com/affaan-m/ECC/blob/main/docs/MCP-CONNECTOR-POLICY.md)
- [Supply-chain incident response](https://github.com/affaan-m/ECC/blob/main/docs/security/supply-chain-incident-response.md)
...
For hook-specific checks, see the [hooks README](https://github.com/affaan-m/ECC/blob/main/hooks/README.md).
...
More answers: [TROUBLESHOOTING.md](https://github.com/affaan-m/ECC/blob/main/TROUBLESHOOTING.md) covers memory, hooks, installation, performance, and common error messages. [docs/TROUBLESHOOTING.md](https://github.com/affaan-m/ECC/blob/main/docs/TROUBLESHOOTING.md) tracks workarounds for open Claude Code bugs.
...
ECC stays free because sponsors and Pro users fund the work. Sponsor logos are at the top of this README; the full roster and tiers are in [SPONSORS.md](https://github.com/affaan-m/ECC/blob/main/SPONSORS.md).
...
| [**ECC Pro**   <sub>Hosted GitHub App for private repos</sub>](https://ecc.tools/pricing) | [**Sponsor ECC**   <sub>Fund the OSS work</sub>](https://github.com/sponsors/affaan-m) | [**Community**   <sub>Q&amp;A, ideas, and Show and Tell</sub>](https://github.com/affaan-m/ECC/discussions) | [**GitHub App**   <sub>PR audits and hosted workflows</sub>](https://github.com/apps/ecc-tools) |
| --- | --- | --- | --- |

[Become a sponsor](https://github.com/sponsors/affaan-m) | [Sponsor tiers](https://github.com/affaan-m/ECC/blob/main/SPONSORS.md) | [Sponsorship program](https://github.com/affaan-m/ECC/blob/main/SPONSORING.md)

**Contributing**

Contributions are welcome across skills, agents, rules, hooks, docs, tests, adapters, and security improvements.

- [Contributing guide](https://github.com/affaan-m/ECC/blob/main/CONTRIBUTING.md)
- [Skill development guide](https://github.com/affaan-m/ECC/blob/main/docs/SKILL-DEVELOPMENT-GUIDE.md)
- [Skill placement policy](https://github.com/affaan-m/ECC/blob/main/docs/SKILL-PLACEMENT-POLICY.md)
...
- **Security Guide:** [Security Guide](https://github.com/affaan-m/ECC/blob/main/the-security-guide.md) | [Thread](https://x.com/affaan/status/2033263813387223421)
